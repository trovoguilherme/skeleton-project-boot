    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar6"><a class="navbar-brand text-primary d-none d-md-block"
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" style=""><a href="${contextPath}/perfil"><img
                        class="img-fluid rounded-circle d-block d-inline-flex"
                        src="${contextPath}/imagens/${usuario.nomeImagem}"
                        style="max-height: 50px; max-width: 50px;"></a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="row">
            <div class="col-md-5 p-4">
                ...
                <div class="col-md-12" style="">
                    <img class="d-block mx-auto rounded-circle" src="${contextPath}/imagens/${usuario.nomeImagem}"
                         style="	max-height: 250px;	max-width: 250px;	min-width: 250px;	min-height: 250px;">
            ...
            <div class="col-md-7 p-4" style="">
                        ...
                        <div class="form-group col-md-6 d-flex align-items-center">
                            <c:if test="${conta == 'prestador'}">
                                <a class="btn btn-warning"
                                   href="https://api.whatsapp.com/send/?phone=${whatsapp}&text&app_absent=0">entrar em
                                    contato</a>
                            </c:if>
                        </div>
                    </div>
                ...
                <c:if test="${conta == 'prestador'}">
                    <a type="submit" class="btn mt-2 mr-2 btn-primary"
                       href="${contextPath}/servico/cadastrar/${usuario.id}">cadastrar serviço</a>
                </c:if>
            </div>
        </div>
    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form:form modelAttribute="comentarioModel"
                                       action="${contextPath}/servico/comentario/${usuario.id}"
                                       method="post">
                                <div class="mb-3">
            ...
            <div class="row">
                <c:forEach items="${comentarios}" var="comentario">
                    <div class="p-4 col-md-6">
                        <img class="img-fluid d-block rounded-circle d-inline-flex"
                             src="${contextPath}/imagens/${imagemDoComentario}"
